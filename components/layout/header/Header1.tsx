...
const [activeCategory, setActiveCategory] = useState<Category>("AI & Data Intelligence");
...
const handleCategoryClick = (category: Category) => {
  setActiveCategory(category);
	...
	return (
		<>
			...
			<div>
				<section className="top-bar position-relative z-4 d-none d-lg-block @@classList ">
						...
						<div className="container py-2">
							<div className="d-flex mb-lg-0 mb-3 flex-wrap align-items-center justify-content-center justify-content-lg-between gap-4">
								<div className="box-infos-contact d-flex align-items-center">
									...
									7901 4th St N # 21891 St. Petersburg, FL 33702
								...
								<div className="box-socials">
									<Link href="https://www.facebook.com/rapidsaii/" className=" text-reset">
										     <FaFacebook size={24} />
									</Link>
				...
				<header>
					<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
						<div className="container px-3">
							<Link className="navbar-brand pe-4" href="/"><img src="/assets/imgs/template/dark-logo.png" alt="" width="150px" /></Link>
							<ul className="navbar-nav gap-1 align-items-lg-center me-auto">
								...
								<li className="nav-item dropdown companylite-dropdown menu-item-has-children">
  <Link
  ...
  <ul className="dropdown-menu companylite-menu">
    <li>
      <Link className="companylite-item" href="/about-us">
        About Company
      </Link>
    </li>
    <li>
          ...
          <p key={`${item.href}-${index}`}>
            <Link href={item.href} className="dropdown-item">
              {item.name}
								...
								<li className="nav-item ">
									<Link className="nav-link fw-medium" href="/projects" role="button" data-bs-toggle="dropdown" aria-expanded="false">Industries</Link>
									{/* <ul className="dropdown-menu">
