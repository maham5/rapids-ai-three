					...
					<div className="row g-0">
						<div className="col-lg-6 testimonial-left-section">
							<div className="d-flex align-items-center justify-content-center h-100">
								<img src="/assets/imgs/pages/home16/review.png" alt="Vatech" className="testimonial-main-image" />
							</div>
						</div>
						<div className="col-lg-6 testimonial-right-section">
							<div className="testimonial-content">
								<div className="paragraph-base-fitree-bold text-underline text-uppercase color-white mb-3 text-center">CUSTOMER TALK</div>
								<h2 className="heading-ag-3xl color-white mb-1 text-center">
									What Our Clients Say For<br />
									Our Services
								</h2>
												...
												<SwiperSlide key={index}>
													<div className="card-testimonials-2 card-testimonials-13">
														<div className="card-info">
															<div className="comment-text sub-heading-md color-white text-center">"{testimonial.comment}"</div>
